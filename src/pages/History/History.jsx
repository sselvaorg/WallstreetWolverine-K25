      ...
      <div className={`${styles.tableContainer}`}>
        ...
        <table className="backdrop-blur-xl p-4 sm:p-6 mt-24 shadow-lg w-[80%] self-start lg:mx-36 md:mx-24 mx-10 rounded-2xl">
          <thead className="p-5 m-4">
            <tr colSpan={3} className="w-[100%] border border-[#aabbcc] border-x-0 border-t-0">
              <th colSpan={1} className="text-md sm:text-lg font-medium w-[30%] text-center text-[#0184ffe5]">
                Company
              </th>
              <th colSpan={1} className="text-md sm:text-lg font-medium w-[30%] text-center text-[#0184ffe5]">
                Quantity
          ...
          {history &&
            ...
            history.map((record, index) => {
              return (
                <tr key={index + 1} className="text-center font-semibold border border-[#3341ff] border-x-0 ">
                  <td className="text-md sm:text-lg font-medium w-[30%] text-center text-[#f4f6f7e5]">{record.company}</td>
                  <td className="text-md sm:text-lg font-medium w-[30%] text-center text-[#f4f6f7e5]">{record.noOfStocks}</td>
                  <td className="text-md sm:text-lg font-medium w-[30%] text-center text-[#f4f6f7e5]">{record.flag}</td>
                </tr>
              );
            })}
          {history.length === 0 && (
