...
import GoogleOAuthLogin from "../../components/Google/GoogleOAuthLogin";
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!firstTimeLogin || firstTimeLogin !== formData.email) {
        ...
        await axios.post("https://api.wsw.kurukshetraceg.org.in/user/login", {
...
//         "https://api.wsw.kurukshetraceg.org.in/user/login",
//         {
//           email: formData.email,
