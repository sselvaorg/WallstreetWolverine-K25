...
function TransactionsPage() {
    ...
    return (
        <div className={`${styles.container} flex flex-col items-center justify-center`}>
            <h1 style={{ color: '#64a0df' }} className="text-3xl font-bold text-center my-6">Transactions</h1>
                    ...
                    <tbody>
                        {dummyTransactions.map((transaction, index) => (
                            <tr key={index} className="bg-gray-100 border-b border-gray-300">
                                <td className="p-3 border border-gray-400">{transaction.company}</td>
                                <td className="p-3 border border-gray-400">{transaction.quantity}</td>
                                <td className="p-3 border border-gray-400">{transaction.flag}</td>
                            </tr>
                        ))}
                    </tbody>
                </table>
